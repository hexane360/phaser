...
def make_raster_scan(shape: t.Tuple[int, int], scan_step: ArrayLike,  # pyright: ignore[reportOverlappingOverload]
                     rotation: float = 0., affine: t.Union[ArrayLike, None] = None, *, dtype: NumT, xp: t.Any = None) -> NDArray[NumT]:
    ...

@t.overload
def make_raster_scan(shape: t.Tuple[int, int], scan_step: ArrayLike,
                     rotation: float = 0., affine: t.Union[ArrayLike, None] = None, *, dtype: t.Optional[DTypeLike] = None, xp: t.Any = None) -> NDArray[numpy.floating]:
    ...

def make_raster_scan(shape: t.Tuple[int, int], scan_step: ArrayLike,
                     rotation: float = 0., affine: t.Union[ArrayLike, None] = None, *, dtype: t.Any = None, xp: t.Any = None) -> NDArray[numpy.number]:
    """
    ...
    if affine is not None:
        affine = xp2.array(affine, dtype=dtype)
