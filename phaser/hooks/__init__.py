...
class CustomTiltProps(Dataclass):
    path: Path
    """Path to file containing a tilt map matching the size of the scan. Either a .npy file
    of shape (ny, nx, 2) or (ny*nx, 2), or a .tilts HDF5 file containing
    'scan/tilt_x' and 'scan/tilt_y' datasets [mrad]."""
    scale: float = 1.0
